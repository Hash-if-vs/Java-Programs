...
Label label;
JTextField t;
JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b0,bdiv,bmul,bsub,badd,beq,bdel,bclr;
...
t=new JTextField();
label.setBounds (200,400, 110, 20);
label.setText("Powered by CASIO");
b1=new JButton("1");
b2=new JButton("2");
b3=new JButton("3");
b4=new JButton("4");
